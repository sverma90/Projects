...
/**
 * Dealer class building deck and showing hands
 * 
 * @author soumilverma
 *
 */
...
public class Dealer {
	//private Deck myDeck = new Deck(this.cardValue, Suit.values()[new Random().nextInt(Suit.values().length)]);
	...
	public void showDealerHand(boolean showCard) {
